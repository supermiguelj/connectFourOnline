...
import com.connectfour.gamestate.GameState;
import com.connectfour.gamestate.SpecialState;
...
import com.connectfour.repository.StatsRepository;
...
public class GameService {
    ...
    public GameState makeMove(String gameID, Player player, int col){
        ...
        if(game.getPlayer2() == null){
            return new SpecialState(gameID, player, SpecialGameCases.WAITING_FOR_PLAYER);
        }
        ...
        if(game.getTurn().equals(player)){
            ...
            if(rowIndex != -1) { // Column is not full
                ...
                if(winner != null){
                    ...
                    return new SpecialState(gameID, player, SpecialGameCases.PLAYER_WIN);
                }
                ...
                if(game.isBoardFull()){
                    ...
                    return new SpecialState(gameID, player, SpecialGameCases.GAME_DRAW);
                }
            ...
            return new SpecialState(gameID, player, SpecialGameCases.COL_IS_FULL);
        }
        return new SpecialState(gameID, player, SpecialGameCases.NOT_YOUR_TURN);
    }
